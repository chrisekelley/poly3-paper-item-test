...
<html>
  <head>
    ...
    <script type="module" src="../../paper-input/paper-input.js"></script>
    <script type="module" src="../paper-item.js"></script>
    <script type="module" src="../paper-icon-item.js"></script>
...
import '../paper-item.js';
import '../paper-icon-item.js';
